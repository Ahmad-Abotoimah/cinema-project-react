              ...
              <ul className="navbar-nav mx-auto" id="main-menu">
                ...
                <li className="nav-item dropdown">
                  ...
                  <ul className="dropdown-menu">
                    ...
                    {/* <!-- Menu Item --> */}
                    <li>
                      <a className="dropdown-item" href="index3.html">
                        Home Version 3
                      </a>
                    </li>
                    ...
                    {/* <!-- Menu Item --> */}
                    <li>
                      <a className="dropdown-item" href="index4.html">
                        Home Version 4
                      </a>
                    </li>
                  </ul>
                ...
                <li className="nav-item dropdown">
                  ...
                  <ul className="dropdown-menu">
                    ...
                    {/* <!-- Menu Item --> */}
                    <li>
                      <a className="dropdown-item" href="celebrities-list.html">
                        celebrities list
                      </a>
                    </li>
                    ...
                    {/* <!-- Menu Item --> */}
                    <li>
                      <a className="dropdown-item" href="celebrities-grid.html">
                        celebrities grid
                      </a>
                    </li>
                    ...
                    {/* <!-- Menu Item --> */}
                    <li>
                      <a className="dropdown-item" href="celebrity-detail.html">
                        celebrity detail
                      </a>
                    </li>
                ...
                <li className="nav-item dropdown">
                  ...
                  <ul className="dropdown-menu">
                    {/* <!-- Menu Item --> */}
                    <li>
                      <a className="dropdown-item" href="movie-list.html">
                        Movie List 1
                      </a>
                    </li>
                    ...
                    {/* <!-- Menu Item --> */}
                    <li>
                      <a className="dropdown-item" href="movie-list2.html">
                        Movie List 2
                      </a>
                    </li>
                    ...
                    {/* <!-- Menu Item --> */}
                    <li>
                      <a className="dropdown-item" href="movie-grid.html">
                        Movie Grid 1
                      </a>
                    </li>
                    ...
                    {/* <!-- Menu Item --> */}
                    <li>
                      <a className="dropdown-item" href="movie-grid2.html">
                        Movie Grid 2
                      </a>
                    </li>
                    ...
                    {/* <!-- Menu Item --> */}
                    <li>
                      <a className="dropdown-item" href="movie-grid3.html">
                        Movie Grid 3
                      </a>
                    </li>
                    ...
                    {/* <!-- Menu Item --> */}
                    <li>
                      <a className="dropdown-item" href="movie-grid4.html">
                        Movie Grid 4
                      </a>
                    </li>
                    ...
                    {/* <!-- Menu Item --> */}
                    <li>
                      <a className="dropdown-item" href="movie-detail2.html">
                        Movie Detail 2
                      </a>
                    </li>
                    ...
                    {/* <!-- Menu Item --> */}
                    <li>
                      <a className="dropdown-item" href="watch-later.html">
                        Watch Later
                      </a>
                    </li>
                  </ul>
                ...
                <li className="nav-item dropdown">
                  ...
                  <ul className="dropdown-menu">
                    ...
                    {/* <!-- Menu Item --> */}
                    <li>
                      <a className="dropdown-item" href="blog-post-detail.html">
                        Blog Detail
                      </a>
                    </li>
